...
__all__ = ['PowerSrc', 'Transducers', 'FlowSrc', 'Simulator', 'Element']
...
class Simulator:
    ...
    @property
    def components(self):
        """Return components dictionary copy."""
    ...
    def _get_reference_node(self):
        ...
        if self.__ref is None:
            ...
            self.logger.debug('REFERENCE NODE %s %s',
